...
<!--                    />-->
                    <div
                      class="bottom-0 text-center absolute w-24 h-12 sm:w-32 sm:h-16 bg-gray-600 bg-opacity-50 rounded-b-full">
            ...
            <div class="mt-6 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                <div class="sm:col-span-1">
                  <div class="text-sm font-medium text-gray-500">{{ $t('word.phone') }}</div>
<!--                  <div v-if="currentUser.phone && currentUser.phone.length > 0" class="mt-1 text-sm text-gray-900">-->
<!--&lt;!&ndash;                    {{ $tools.phoneFormatter(currentUser.phone) }}&ndash;&gt;-->
<!--                  </div>-->
                </div>
...
<!--                  <div class="mt-1 text-sm text-gray-900">{{ currentUser.address }}</div>-->
                </div>

                <div class="sm:col-span-1">
                  <div class="text-sm font-medium text-gray-500">{{ $t('word.gender') }}</div>
<!--                  <div class="mt-1 text-sm text-gray-900">{{ currentUser.gender }}</div>-->
                </div>

                <div class="sm:col-span-1">
                  <div class="text-sm font-medium text-gray-500">{{ $t('text.languageOfSystem') }}</div>
<!--                  <div class="mt-1 text-sm text-gray-900">{{ currentUser.language }}</div>-->
                </div>
